package com.example.caribeux.myfirstapp;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener,GoogleApiClient.OnConnectionFailedListener{
    ...
    private LinearLayout Profile_Section,Login_Section;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Profile_Section = (LinearLayout)findViewById(R.id.prof_section);
    ...
    private void updateView(boolean is_login){
        if(is_login)
        {
